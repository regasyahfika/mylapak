			...
			<div class="row">
						...
						?>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="produkbykategori.php?id_kategori=<?php echo $r['id_kategori_produk'];?>"><?php echo $r['nama_kategori'];?></a></h4>
								</div>
							</div>
							<?php } ?>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Produk Berdasarkan Kategori</h2>
							<?php 
								$id_kat=$_GET['id_kategori'];
								$q=mysqli_query($koneksi, "SELECT * FROM tbl_produk WHERE id_kategori_produk=$id_kat");
								while($r=mysqli_fetch_array($q)){
								?>
						<div class="col-sm-4">
