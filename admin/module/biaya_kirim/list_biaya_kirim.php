                    ...
                    <tr>
                      ...
                      <th>Biaya</th>
					   <th style="width: 110px">Aksi</th>
      					...
      					$kueriKirim= mysqli_query($koneksi, "select * from tbl_biaya_kirim");
                    ...
                    <tr>      
					  ...
					  <td>
					   <div class="btn-group">
                          ...
                          <a href="<?php echo $admin_url; ?>module/biaya_kirim/aksi_hapus.php?id_biaya_kirim=<?php echo $kir['id_biaya_kirim'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger"><i class='fa fa-power-off'></i></button></a>
                        </div>
					  </td>
                    </tr>
              <?php } ?>
